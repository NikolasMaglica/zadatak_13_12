<?php 
	...
	if (!isset($action)) {
		...
		if ($action == 1) {
			$_SESSION['last_opened'] = "US growth faster than expected";
			print '
			...
			$_SESSION['last_opened'] = "Wall Street: Tech firm surge pushes US markets higher";
			...
			# inicijalizacija kolačića
			$_SESSION['last_opened'] = "Hotel booking sites probed by consumer watchdog";
	...
	if (isset($_SESSION['last_opened'])) {
		print '<p><strong>Last opened news:</strong> ' . $_SESSION['last_opened'] . '</p>';
	}
	print '
	</div>';
